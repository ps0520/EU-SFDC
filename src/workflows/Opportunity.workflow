...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    ...
    <outboundMessages>
        ...
        <endpointUrl>https://eu.test.connect.boomi.com/ws/soap/createeusalesforceopportunity;boomi_auth=c2FsZXNmb3JjZUBkZXhjb21pbmMtNk82SjBPLjRUUTlLSjo0ZDY2MTg3OS0xMjc2LTRiNGMtODNkYy0xMGM3NzJjZjVjNzk=</endpointUrl>
        <fields>Id</fields>
...
BEGINS(RecordType.DeveloperName, &apos;AT&apos;),ISPICKVAL(StageName, &apos;Customer Doc Collection&apos;),ISPICKVAL(Type, &apos;Reorder&apos;))</formula>
    ...
    ISBLANK(Parent_Opportunity__c),   	
	ISCHANGED(EGEKO_Out__c), 	
	PRIORVALUE( EGEKO_Out__c ) = FALSE, 	
	EGEKO_Out__c = TRUE 
)</formula>
